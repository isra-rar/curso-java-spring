...
import com.springweb.course.domain.Payment;
...
import com.springweb.course.repositories.OrdemItemRepository;
...
public class Configuracao implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.now(), OrderStatus.WAITNG_PAYMENT, u1);
        Order o2 = new Order(null, Instant.now(), OrderStatus.PAID, u2);
        Order o3 = new Order(null, Instant.now(), OrderStatus.DELIVERED, u2);
